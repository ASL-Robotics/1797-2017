...
public class Main {
	...
	public static ArrayList<Rect> targetRects;
	...
	public static void main(String[] args) {
		...
		// USB Camera
		/*
		 * // This gets the image from a USB camera // Usually this will be on
		 * device 0, but there are other overloads // that can be used UsbCamera
		 * camera = setUsbCamera(0, inputStream); // Set the resolution for our
		 * camera, since this is over USB camera.setResolution(640,480);
		 */
		...
		// operations
		CvSource imageSource = new CvSource("CV Image Source", VideoMode.PixelFormat.kMJPEG, 160, 90, 30);
		...
		while (true) {
			...
			for (int i = 0; i < contours.size(); i++) {
				...
				// System.out.print(targetRects.get(i).x + " ");
			}
